...
class Settings(BaseSettings):
    ...
    original_hpo_mapper_db_path: str | None = Field(default=None, alias="RAREDX_ORIGINAL_HPO_MAPPER_DB_PATH")
    original_hpo_mapper_hpo_json: str | None = Field(default=None, alias="RAREDX_ORIGINAL_HPO_MAPPER_HPO_JSON")
    original_hpo_mapper_max_genes: int = Field(default=50, alias="RAREDX_ORIGINAL_HPO_MAPPER_MAX_GENES")
