...
- 현재 HPO graph embedding은 빠른 baseline을 위한 deterministic random-walk/hash 방식이다. DeepWalk는 uniform walk, Node2Vec는 biased walk로 분리했지만, 엄밀한 skip-gram 학습이나 GCN/GraphSAGE 학습은 아직 구현하지 않았다.
